<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"/home/wwwroot/dwj/public/../app/admin/view/lottery/betting_ben.html";i:1530024494;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb panel">
                ...
                <li class="active">本期下注,当前期数<?php echo $stage; ?></li>
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>
                ...
                <header class="panel-heading col-xs-12 ">
                    <form class="form-inline" action="<?php echo url('',array('id'=>$id)); ?>">
                        <div class="form-group">
                            <input type="text" name="stage" class="form-control" value="<?php echo isset($_GET['stage']) ? $_GET['stage'] :  ''; ?>" placeholder="请输期数">
