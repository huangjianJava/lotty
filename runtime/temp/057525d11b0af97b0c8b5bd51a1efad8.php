<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/home/wwwroot/dwj/public/../app/admin/view/lottery/eight_pei.html";i:1529506243;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb panel">
                ...
                <li><a href="<?php echo url('index'); ?>">赔率设置</a></li>
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>
    <div class="row">
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    <form class="gameForm"  method="post" action="<?php echo url('edit_pei'); ?>">
                    <header class="panel-heading">
                    </header>
                    <div class="panel-body">
                        <div class="col-sm-5">
                        <div class="adv-table editable-table ">
                            <div> <label class="control-label"><?php echo $cate_name; ?>--><?php echo $hall_name; ?>--><?php echo $type_name; ?>-->赔率设置</label></div>
                            <div  style="float: left">
                            <?php if(!(empty($data_s) || (($data_s instanceof \think\Collection || $data_s instanceof \think\Paginator ) && $data_s->isEmpty()))): ?>
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tbody>
                                <?php foreach($data_s as $k=>$v): ?>
                                <tr>
                                    <td><?php echo $v['rule']; ?></td>
                                    <td>
                                        <input type="text" class="form-control small" name="<?php echo $v['id']; ?>" value="<?php echo $v['rate']; ?>">
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                </tbody>
                           ...
                           <?php endif; ?>
                            ...
                            <div style="float: left">
                            <?php if(!(empty($data_d) || (($data_d instanceof \think\Collection || $data_d instanceof \think\Paginator ) && $data_d->isEmpty()))): ?>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10">
                                <button class="btn btn-primary " target-form="gameForm"  type="submit">保存</button>
                            </div>
                        </div>
                    </div>
                    </div>
