<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"/home/wwwroot/dwj/public/../app/admin/view/lottery/open_result.html";i:1526747663;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    <div class="row">
        ...
        <div class="panel-body">
            <form method="post" action="<?php echo url('add_open'); ?>" class="form-horizontal bucket-form">
                <div class="form-group">
                    <label class="col-sm-1 control-label">开奖彩种</label>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    <label class="col-sm-1 control-label">开奖期数</label>
                    <div class="col-sm-11">
                       <input type="text" name="stage" value="" size="32">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-1 control-label">开奖号码</label>
                    <div class="col-sm-11">
                        <input type="text" name="number" value="" size="60">
                        <span style="color: green">温馨提示：开奖号码用英文输入法逗号隔开</span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 right">
                        <button class="btn btn-primary " target-form="bucket-form"  type="submit">添加</button>
                    </div>
                </div>
            </form>
        </div>
