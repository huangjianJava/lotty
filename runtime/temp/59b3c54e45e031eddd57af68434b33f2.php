<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"/home/wwwroot/dwj/public/../app/admin/view/member/robot_way.html";i:1524646516;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <form class="ids" action="" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo url('del_robot_way',array('id'=>$v['id'])); ?>" class="fa fa-times confirm " onclick="return confirm('确定删除?删除后将不能找回');" title="删除"></a>
                                </td>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="rechargeModal" class="modal fade">
    <div class="modal-dialog" style="width:400px;">
        <div class="modal-content">
            ...
            <form class="form-horizontal form-post-addmoney" action="<?php echo url('member/robot_way_add'); ?>" method="post">
