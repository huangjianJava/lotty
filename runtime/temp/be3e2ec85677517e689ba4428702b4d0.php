<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"/home/wwwroot/dwj/public/../app/admin/view/lottery/open.html";i:1513152052;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    <div class="row">
        ...
        <div class="panel-body">
            <form method="post" action="<?php echo url('open_edit'); ?>" class="form-horizontal bucket-form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                       <input type="text" value="" name="stage">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 right">
                        <button class="btn btn-primary " target-form="bucket-form"  type="submit">开奖</button>
                    </div>
                </div>
            </form>
        </div>
