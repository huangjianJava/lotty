<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"/home/wwwroot/dwj/public/../app/admin/view/operation/do_delete.html";i:1530024787;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <section class="panel">
                <div class="panel-body">
                    <span style="color: green">温馨提示:删除后数据将不能找回，请谨慎使用</span>
                    <form class="ids" action="" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="fa fa-times confirm " onclick="do_del(1)" title="删除"></a>
                                </td>
                            </tr>
                            <tr>
                                <td>登陆日志表</td>
                                ...
                                <td>
                                    <a href="#" class="fa fa-times confirm " onclick="do_del(2)" title="删除"></a>
                                </td>
                            </tr>
                            <tr>
                                <td>操作日志表</td>
                                <td><input type="text" id="3" value=""></td>
                                <td>
                                    <a href="#" class="fa fa-times confirm " onclick="do_del(3)" title="删除"></a>
                                </td>
                            </tr>
                            <tr>
                                <td>开奖历史表</td>
                                ...
                                <td>
                                    <a href="#" class="fa fa-times confirm " onclick="do_del(4)" title="删除"></a>
                                </td>
                            </tr>
                            <tr>
                                <td>充值表</td>
                                <td><input type="text" id="5" value=""></td>
                                <td>
                                    <a href="#" class="fa fa-times confirm " onclick="do_del(5)" title="删除"></a>
                                </td>
                            </tr>
                            <tr>
                                <td>提现表</td>
                                <td><input type="text" id="6" value=""></td>
                                <td>
                                    <a href="#" class="fa fa-times confirm " onclick="do_del(6)" title="删除"></a>
                                </td>
                            </tr>
                            <tr>
                                <td>投注记录表</td>
                                <td><input type="text" id="7" value=""></td>
                                <td>
                                    <a href="#" class="fa fa-times confirm " onclick="do_del(7)" title="删除"></a>
                                </td>
                            </tr>
                            <tr>
                                <td>流水记录表</td>
                                <td><input type="text" id="8" value=""></td>
                                <td>
                                    <a href="#" class="fa fa-times confirm " onclick="do_del(8)" title="删除"></a>
                                </td>
                            </tr>
...
<script type="text/javascript">
    ...
    function do_del(type) {
        var day = document.getElementById(type).value;

        $.ajax({
            type: "post",
            url: "<?php echo url('do_delete'); ?>",
            data: {'id':type,'day':day},
            dataType: "json",
            async: false,
