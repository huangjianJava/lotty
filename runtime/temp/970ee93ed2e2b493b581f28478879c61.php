<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"/home/wwwroot/dwj/public/../app/admin/view/member/robot.html";i:1525227468;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
            ...
            <section class="panel">
                <header class="panel-heading col-xs-12">
                    ...
                    <form class="form-inline" action="<?php echo url(); ?>">
                        ...
                        <a href="<?php echo url('member/robot_way'); ?>"  class="btn btn-success " title="投注规则">机器人投注规则</a>
                    </form>
                </header>
                    ...
                    <form class="ids" action="" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php echo $v['id']; ?></td>
                                <td><img style="border-radius: 50%" width="50" src="URL_IMG<?php echo $v['logo']; ?>" class="aaa"></td>
