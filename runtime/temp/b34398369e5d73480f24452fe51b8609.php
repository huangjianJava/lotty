<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/home/wwwroot/dwj/public/../app/admin/view/money/transaction.html";i:1530453853;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-inline" action="<?php echo url('',array('id'=>$id)); ?>">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="exp">
                                ...
                                <option value="1" <?php if((isset($_GET['exp']) && $_GET['exp'] == 1)): ?>selected<?php endif; ?>>充值</option>
                                <option value='2' <?php if((isset($_GET['exp']) && $_GET['exp'] == 2)): ?>selected<?php endif; ?>>中奖</option>
                                <option value='3' <?php if((isset($_GET['exp']) && $_GET['exp'] == 3)): ?>selected<?php endif; ?>>投注回水</option>
                                <option value='5' <?php if((isset($_GET['exp']) && $_GET['exp'] == 5)): ?>selected<?php endif; ?>>投注</option>
                                <option value='6' <?php if((isset($_GET['exp']) && $_GET['exp'] == 6)): ?>selected<?php endif; ?>>提现申请</option>
                                <option value='7' <?php if((isset($_GET['exp']) && $_GET['exp'] == 7)): ?>selected<?php endif; ?>>提现拒绝</option>
                            </select>
                            <input type="text" name="mobile" value="<?php echo isset($_GET['mobile']) ? $_GET['mobile'] :  ''; ?>" class="form-control" placeholder="请输入用户名">
                    ...
                    <form class="ids" action="" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php echo $v['member']['mobile']; ?></td>
                                <td><?php echo $v['member']['nickname']; ?></td>
                                <td><?php echo $v['money']; ?></td>
                                <td><?php echo $v['balance']; ?></td>
                                <td><?php if($v['exp']==1): ?>充值<?php elseif($v['exp']==2): ?>中奖<?php elseif($v['exp']==3): ?>投注回水<?php elseif($v['exp']==5): ?>投注<?php elseif($v['exp']==6): ?>提现申请<?php elseif($v['exp']==7): ?>提现拒绝<?php elseif($v['exp']==8): ?>撤单<?php endif; ?></td>
