<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/home/wwwroot/dwj/public/../app/admin/view/operation/index.html";i:1529812752;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
        ...
        <div class="panel-body">
            <form method="post" action="<?php echo url('edit'); ?>" class="form-horizontal bucket-form">
                <div class="form-group ">
                    ...
                    <div class="col-lg-6">
                        <input name="dao_time" type="text" value="<?php echo $data['dao_time']; ?>" />
                    </div>
                </div>
                <div class="form-group ">
                    <label  class="control-label col-lg-2">封盘开始秒数</label>
                    <div class="col-lg-6">
                        <input name="feng_time" type="text" value="<?php echo $data['feng_time']; ?>" />
                    </div>
                </div>
                <div class="form-group ">
                    <label  class="control-label col-lg-2">竞猜核对开始秒数</label>
                    <div class="col-lg-6">
                        <input name="jing_time" type="text" value="<?php echo $data['jing_time']; ?>" />
                    </div>
                </div>
                <div class="form-group ">
                    <label  class="control-label col-lg-2">虚拟在线人数</label>
                    <div class="col-lg-6">
                        <input name="call_time" type="text" value="<?php echo $data['x_numbers']; ?>" />
                    </div>
                </div>
                <div class="form-group ">
                    <label  class="control-label col-lg-2">账单标语</label>
                    <div class="col-lg-6">
                        <input name="zhang" type="text" value="<?php echo $data['zhang']; ?>" />
                    </div>
                </div>
                <div class="form-group ">
                    ...
                    <div class="col-lg-6">
                        <p class="bor_b left mg_tb10">
                            <img height="150px" id="wx_img"  src="URL_IMG<?php echo $data['wx']; ?>"/><br />
                            ...
                            <span class="file_p text-center" id="btn_logo">
                                           ...
                                           <input type="hidden" name="wx" value="<?php echo $data['wx']; ?>"/>
                             </span>
                        </p>
                    </div>
                </div>
