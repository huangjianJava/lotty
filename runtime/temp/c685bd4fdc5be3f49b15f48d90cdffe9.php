<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/home/wwwroot/dwj/public/../app/admin/view/lottery/history.html";i:1513155992;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb panel">
                ...
                <li class="active">(<?php echo $cate_name; ?>)历史记录</li>
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>
                    ...
                    <form class="ids" action="" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>  <a href="<?php echo url('del_history',array('cate'=>$cate,'id'=>$v['id'])); ?>" class="btn btn-sm btn-danger confirm" >删除</a></td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </table>
                    </form>
