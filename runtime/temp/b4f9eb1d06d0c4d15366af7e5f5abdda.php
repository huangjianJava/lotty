<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"/home/wwwroot/dwj/public/../app/admin/view/lottery/index.html";i:1524639242;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <form class="ids" action="" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><img width="100" src="URL_IMG<?php echo $v['cate_img']; ?>"></td>
                                <td><?php if($v['status'] ==1): ?> 开放<?php else: ?>关闭<?php endif; ?></td>

                                <td>
                                    <a href="<?php echo url('lottery/eight_index',array('cate'=>$v['id'])); ?>"  title="玩法(赔率)设置">玩法(赔率)设置</a>
                                </td>
                                <td>
                                    <a href="<?php echo url('lottery/play_rule',array('cate'=>$v['id'])); ?>"  title="游戏规则设置">游戏规则设置</a>
                                </td>
                                <td>

                                    <a href="<?php echo url('lottery/history',array('cate'=>$v['id'])); ?>"  title="开奖历史">开奖历史</a>

                                </td>
                                <td>
                                    <a href="<?php echo url('lottery/show',['id'=>$v['id']]); ?>" class="fa fa-edit" title="编辑"></a>
