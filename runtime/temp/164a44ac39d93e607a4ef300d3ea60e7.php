<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"/home/wwwroot/dwj/public/../app/admin/view/notice/system_edit.html";i:1527136348;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1530454306;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="row">
        ...
        <div class="panel-body">
            <form method="post" action="<?php echo url('system_edit'); ?>" class="form-horizontal bucket-form">
                ...
                <!--<div class="form-group">-->
                    ...
                    <!--<div class="col-sm-11">-->
                        <!--<textarea class="form-control" id="editor" name="content"  rows="10"><?php echo $data['content']; ?></textarea>-->
                    <!--</div>-->
                <!--</div>-->
