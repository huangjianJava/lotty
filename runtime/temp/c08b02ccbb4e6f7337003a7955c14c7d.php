<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"/home/wwwroot/dwj/public/../app/admin/view/lottery/eight_index.html";i:1527210828;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb panel">
                ...
                <li><a href="<?php echo url('index'); ?>"><?php echo $cate_name; ?></a></li>
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>
    ...
    <div class="row">
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    <form class="gameForm"  method="post" action="<?php echo url('eight_edit'); ?>">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tbody>
                               <?php foreach($v['play_rules'] as $kk=>$vv): ?>
                                <tr>
                                    <td><?php echo $vv['title']; ?></td>
                                    <td><a href="<?php echo url('eight_pei',array('type'=>$vv['type'],'hall'=>$v['hall'],'cate'=>$v['cate'])); ?>">点击进入赔率设置</a></td>
                                    <td><input type="text" id="from_<?php echo $vv['id']; ?>" value="<?php echo $vv['from']; ?>"></td>
                                    <td><input type="text" id="to_<?php echo $vv['id']; ?>" value="<?php echo $vv['to']; ?>"></td>
                                    <td><input type="text" id="max_<?php echo $vv['id']; ?>" value="<?php echo $vv['max']; ?>"></td>
                                    <td > <a href="#" style="color: white" class="btn btn-success ajax-get" onclick="edit_bet_number('<?php echo $vv['id']; ?>')" title="保存">保存</a></td>
                                </tr>
                               <?php endforeach; ?>
                                </tbody>
                            </table>
...
<script type="text/javascript">
    ...
    function edit_bet_number(id) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('edit_bet_number'); ?>",
