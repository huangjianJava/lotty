<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"/home/wwwroot/dwj/public/../app/admin/view/member/edit.html";i:1524635892;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form">
                        <form class="form-horizontal adminex-form userForm"  method="post" action="<?php echo url('Member/edit'); ?>">
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">用户名</label>
                                <div class="col-lg-3">
                                    <span class=" form-control"><?php echo $info['mobile']; ?></span>
                                    <!--<input class=" form-control" name="mobile" value="<?php echo $info['mobile']; ?>" type="text" />-->
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">用户昵称</label>
                                <div class="col-lg-3">
                                    <input class=" form-control" name="nickname" value="<?php echo $info['nickname']; ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">用户余额</label>
                                <div class="col-lg-3">
                                    <span class=" form-control"><?php echo $info['money']; ?></span>
                                </div>
                            </div>
                            <div class="form-group">
