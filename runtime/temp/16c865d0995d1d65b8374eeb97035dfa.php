<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/home/wwwroot/dwj/public/../app/admin/view/lottery/play_rule.html";i:1524640702;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="form">
                        <form action="<?php echo url(''); ?>" method="post" class="form-horizontal">
                            <div class="form-group">
                                <div class="col-sm-10">
                                    <textarea id="editor" class="form-control ckeditor" name="play_rule"  rows="10"><?php echo $data['play_rule']; ?></textarea>
                                </div>
                            </div>
