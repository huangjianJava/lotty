<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"/home/wwwroot/dwj/public/../app/admin/view/money/member_win.html";i:1530801263;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb panel">
                ...
                <li class="active">会员盈亏(默认显示今日盈亏 )</li>
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>
                ...
                <header class="panel-heading col-xs-12 ">
                    <form class="form-inline" action="<?php echo url(''); ?>">
                        <div class="form-group">
                            ...
                            <input type="text" name="mobile" class="form-control" value="<?php echo isset($_GET['mobile']) ? $_GET['mobile'] :  ''; ?>" placeholder="请输入用户">
                    ...
                    <form class="ids" action="" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php echo $v['z_money']-$v['money']; ?></td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <td>总计</td>
                            <td></td>
