<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"/home/wwwroot/dwj/public/../app/admin/view/users/index.html";i:1508550340;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
            ...
            <section class="panel">
                <div class="panel-body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td><input class="ids" type="checkbox" value="<?php echo $v['uid']; ?>" name="ids[]"/></td>
                            <td><?php echo $v['uid']; ?></td>
                            <td><?php echo $v['username']; ?></td>
                            <td><?php if(($v['role'] == 0)): ?>超级管理员<?php else: ?>管理员<?php endif; ?></td>
                            <td><?php if(($v['lg_ip'])): ?><?php echo $v['lg_ip']; endif; ?></td>
                            <td><?php if(($v['lg_time'])): ?><?php echo date('Y-m-d H:i:s',$v['lg_time']); endif; ?></td>
                            <td>
                                <?php if(($v['role'] != 0)): ?>
                                <a href="<?php echo url('edit',['id'=>$v['uid']]); ?>" class="fa fa-edit" title="编辑"></a>
                                <a href="<?php echo url('del',array('ids'=>$v['uid'])); ?>" class="fa fa-times confirm ajax-get" title="删除"></a>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
