<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"/home/wwwroot/dwj/public/../app/admin/view/member/member_down.html";i:1527089588;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <form class="ids" action="<?php echo url('del'); ?>" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php echo (isset($v['betting_money']) && ($v['betting_money'] !== '')?$v['betting_money']:'0.00'); ?></td>
                                <td><?php echo (isset($v['betting_zmoney']) && ($v['betting_zmoney'] !== '')?$v['betting_zmoney']:'0.00'); ?></td>
                                <td><?php echo (isset($v['win_lose']) && ($v['win_lose'] !== '')?$v['win_lose']:'0.00'); ?></td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
