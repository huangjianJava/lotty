<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:57:"/home/wwwroot/dwj/public/../app/admin/view/nav/index.html";i:1511334288;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <ul id="myTab" class="nav nav-tabs">
        <li class="active"><a href="<?php echo url('index'); ?>" data-toggle="tab">菜单列表</a></li>
        <li><a href="javascript:;" onclick="add()">添加菜单</a></li>
    </ul>

    <form action="<?php echo url('Nav/order'); ?>" method="post">
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <tr>
                        <td><input class="form-control" style="width:40px;height:25px;" type="text" name="<?php echo $v['id']; ?>"
                                   value="<?php echo $v['sort']; ?>"></td>
                        <td><?php echo $v['_name']; ?></td>
                        <td><?php echo $v['act']; ?></td>
                        <td><?php echo $v['control']; ?></td>
                        <td><?php echo $v['icon']; ?></td>
                        <td><?php echo $v['status']; ?></td>
                        <td><a href="javascript:;" navId="<?php echo $v['id']; ?>" navName="<?php echo $v['name']; ?>"  onclick="add_child(this)">添加子菜单</a>
                            | <a href="javascript:;" navStatus="<?php echo $v['status']; ?>" navId="<?php echo $v['id']; ?>" navName="<?php echo $v['name']; ?>" controller="<?php echo $v['control']; ?>" navMca="<?php echo $v['act']; ?>"
                                 navIco="<?php echo $v['icon']; ?>" onclick="edit(this)">修改</a>
                            | <a href="<?php echo url('Nav/delete',array('id'=>$v['id'])); ?>" onclick="confirm('确认删除？')">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="bjy-form" class="form-inline" action="<?php echo url('Nav/add'); ?>" method="post"><input
    ...
    <div class="modal fade" id="bjy-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="bjy-form" class="form-inline" action="<?php echo url('Nav/edit'); ?>" method="post"><input
                            type="hidden" name="id">
                        <table class="table table-striped table-bordered table-hover table-condensed">
                            <tr>
                                <th width="12%">菜单名：</th>
