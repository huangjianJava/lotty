<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"/home/wwwroot/dwj/public/../app/admin/view/notice/call_edit.html";i:1527605690;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1530454306;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="row">
        ...
        <div class="panel-body">
            <form method="post" action="<?php echo url('call_edit'); ?>" class="form-horizontal bucket-form">
                <div class="form-group">
                    <label class="col-sm-1 control-label">公告标题</label>
                    <div class="col-sm-11">
                        <input type="text" name="info" class="form-control" value="<?php echo $data['info']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-1 control-label">距封盘时间（s）</label>
                    <div class="col-sm-11">
                        <input type="text" name="call_time" class="form-control" value="<?php echo $data['call_time']; ?>">
                    </div>
                </div>
...
<script>
    ...
    CKEDITOR.replace('editor', {
        height: 500,
        filebrowserUploadUrl: "<?php echo url('upload_one_ck'); ?>" //设置图片上传请求地址
    });
</script>
