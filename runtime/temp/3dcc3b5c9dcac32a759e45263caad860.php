<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"/home/wwwroot/dwj/public/../app/admin/view/money/back_to_client.html";i:1522742338;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
        ...
        <div class="panel-body">
            <header class="panel-heading col-xs-12">
                    ...
                    <div class="form-group">
                        <a href="<?php echo url('back_client_detail'); ?>"  class="btn btn-primary" title="返还记录">返还记录</a>
                    </div>

            </header>
            <form method="post" action="<?php echo url('add_back_money'); ?>" class="form-horizontal bucket-form">
                <div class="form-group">
                    <label class="col-sm-1 control-label">返还彩种</label>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    <label class="col-sm-1 control-label">返还期数</label>
                    <div class="col-sm-11">
                       <input type="text" name="stage" value="" size="32">   <span style="color: green"></span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-1 control-label"></label>
                    <div class="col-lg-10 right">
                        <button class="btn btn-primary " target-form="bucket-form"  type="submit">确认</button>
                    </div>
                </div>
            </form>
        </div>
