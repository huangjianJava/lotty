<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"/home/wwwroot/dwj/public/../app/admin/view/index/index.html";i:1534863515;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    <div class="row">
        ...
        <h2 style="text-align: center;font-size: xx-large; color: #65CEA7;margin-top: 100px">欢迎来到天猫国际后台管理系统</h2>

        <header class="panel-heading col-xs-12 ">
            <a href="<?php echo url('money/recharge'); ?>"  class="btn btn-primary " title="充值待审核">充值待审核（<?php echo (isset($back['recharge_wait']) && ($back['recharge_wait'] !== '')?$back['recharge_wait']:0.00); ?>）</a>
            <a href="<?php echo url('money/cash'); ?>"  class="btn btn-primary " title="提现待审核">提现待审核（<?php echo (isset($back['withdraw_wait']) && ($back['withdraw_wait'] !== '')?$back['withdraw_wait']:0.00); ?>）</a>
        </header>

        <div class="row states-info" style="margin-top: 100px">
            <div class="col-md-3">
                <div class="panel yellow-bg" style="height: 150px">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                <span class="state-title">  会员总数  </span>
                                <h4><?php echo $back['member_number']; ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="panel blue-bg" style="height: 150px">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-4">
                            ...
                            <div class="col-xs-8">
                                <span class="state-title">  余额总额  </span>
                                <h4><?php echo (isset($back['balance_total']) && ($back['balance_total'] !== '')?$back['balance_total']:0.00); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="panel red-bg" style="height: 150px">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-4">
                                <i class="fa fa-eye"></i>
                            ...
                            <div class="col-xs-8">
                                <span class="state-title">  今日盈亏  </span>
                                <h4><?php echo (isset($back['win_lose']) && ($back['win_lose'] !== '')?$back['win_lose']:0.00); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row states-info" style="margin-top: 20px">
            <div class="col-md-3" >
                <div class="panel yellow-bg" style="height: 150px">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                <span class="state-title"> 今日充值 </span>
                                <h4><?php echo (isset($back['today_recharge']) && ($back['today_recharge'] !== '')?$back['today_recharge']:0.00); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="panel green-bg" style="height: 150px">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-4">
                                <i class="fa fa-tag"></i>
                            ...
                            <div class="col-xs-8">
                                <span class="state-title">  今日提现  </span>
                                <h4><?php echo (isset($back['today_withdraw']) && ($back['today_withdraw'] !== '')?$back['today_withdraw']:0.00); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
