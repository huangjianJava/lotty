<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"/home/wwwroot/dwj/public/../app/admin/view/notice/system.html";i:1520582622;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
            ...
            <section class="panel">
                <header class="panel-heading col-xs-12 ">
                        <div class="form-group">
                            <a href="#"  class="btn btn-success ajax-get" onclick="recharge();"title="添加公告">添加公告</a>
                        </div>
                    ...
                    <form class="ids" action="" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo url('notice/system_show',['id'=>$v['id']]); ?>" class="fa fa-edit" title="编辑"></a>
                                    <a href="<?php echo url('notice/system_del',['id'=>$v['id']]); ?>" class="fa fa-times confirm " onclick="return confirm('确定删除?');" title="删除"></a>
                                    <?php if($v['is_show']==0): ?>
                                    <a href="#"   class="btn btn-success ajax-get" onclick="is_show('<?php echo $v['id']; ?>',1)" title="轮播显示">轮播显示</a>
                                    <?php else: ?>
                                    <a href="#"   class="btn btn-danger ajax-get" onclick="is_show('<?php echo $v['id']; ?>',0)" title="轮播取消">轮播取消</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="rechargeModal" class="modal fade">
    <div class="modal-dialog" style="width:400px;">
        <div class="modal-content">
            ...
            <form class="form-horizontal form-post-addmoney" action="<?php echo url('add_system'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-lg-3 col-sm-3 control-label">公告内容</label>
                        <div class="col-lg-8">
...
<script type="text/javascript">
    ...
    function is_show(id,is_show) {
        $.ajax({
            type: "post",
            url: "<?php echo url('notice/is_show'); ?>",
