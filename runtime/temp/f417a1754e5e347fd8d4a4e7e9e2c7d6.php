<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/home/wwwroot/dwj/public/../app/admin/view/rule/check_user.html";i:1510670764;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <ul id="myTab" class="nav nav-tabs">
        ...
        <li><a href="javascript:;" onclick="add()">用户组添加</a></li>
    </ul>
        ...
        <div class="tab-pane fade in active" id="home">
            <table class="table table-striped table-bordered table-hover table-condensed">
                <tr>
                    ...
                    <td>
                        <form class="form-inline" action=""><input class="form-control" type="text" name="username"
                                                                   value="<?php echo \think\Request::instance()->get('username'); ?>"> <input class="btn btn-success"
            ...
            <table class="table table-striped table-bordered table-hover table-condensed">
                ...
                <?php if($user_data): foreach($user_data as $v): ?>
                <tr>
                    <th><?php echo $v['username']; ?></th>
                    <td>

                        <?php if(in_array(($v['id']), is_array($uids)?$uids:explode(',',$uids))): ?>
                        已经是<?php echo $group_name; else: ?>
                        <a href="<?php echo url('Rule/add_user_to_group',array('uid'=>$v['id'],'group_id'=>$group_id)); ?>">设为<?php echo $group_name; ?></a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; else: ?>
