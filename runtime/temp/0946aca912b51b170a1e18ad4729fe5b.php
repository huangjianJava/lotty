<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"/home/wwwroot/dwj/public/../app/home/view/mine/recharge_record.html";i:1534861865;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
	<meta charset="UTF-8">
				...
				<li>
					...
					<span>
						<?php if($v['status']==1): ?>
							...
							<b style="color:#cf3138 ">上芬成功</b>
							+<?php echo $v['money']; elseif($v['status']==3): ?>
							 <b style="color:#868686 ">上芬失败</b>
