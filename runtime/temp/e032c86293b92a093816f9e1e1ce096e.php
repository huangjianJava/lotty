<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/home/wwwroot/dwj/public/../app/admin/view/lottery/open_time_show.html";i:1519373886;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <form class="ids" action="" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="num[<?php echo $v['id']; ?>][dateline]" id = "open0_<?php echo $v['id']; ?>" value="<?php echo $v['dateline']; ?>"></td>
                                <td><input type="text" name="num[<?php echo $v['id']; ?>][open]" id = "open_<?php echo $v['id']; ?>" value="<?php echo $v['open']; ?>"></td>
                                <td><input type="hidden" name="num[<?php echo $v['id']; ?>][id]" value="<?php echo $v['id']; ?>"></td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                        </table>
...
<script type="text/javascript">
    ...
    function edit_open_time() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('open_time_edit'); ?>",
            data:  dd.serialize(),
            dataType: "json",
            async: false,
