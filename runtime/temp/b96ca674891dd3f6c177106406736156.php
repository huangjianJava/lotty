<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"/home/wwwroot/dwj/public/../app/admin/view/member/login_log.html";i:1524641034;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                    ...
                    <form class="ids" action="<?php echo url('del'); ?>" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php if($v['login_way']==1): ?>
                                    安卓
                                    <?php elseif($v['login_way']==2): ?>
                                    IOS
                                    <?php else: ?>
                                    Web
                                    <?php endif; ?>
                                </td>
                                <td><?php echo $v['minute']; ?>小时</td>
