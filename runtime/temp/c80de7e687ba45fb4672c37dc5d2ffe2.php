<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"/home/wwwroot/dwj/public/../app/admin/view/notice/call.html";i:1529503703;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb panel">
                ...
                <li><a href="<?php echo url('index'); ?>">喊话管理</a></li>
                    ...
                    <form class="ids" action="" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php echo $v['call_time']; ?></td>
                                <td><?php echo $v['content']; ?></td>
                                <td><?php echo $v['create_time']; ?></td>
                                <td>
                                    <a href="<?php echo url('notice/call_show',['id'=>$v['id']]); ?>" class="fa fa-edit" title="编辑"></a>
                                    <?php if($v['is_show']==0): ?>
                                    <a href="#"   class="btn btn-success ajax-get" onclick="is_show('<?php echo $v['id']; ?>',1)" title="开启">开启</a>
                                    <?php else: ?>
                                    <a href="#"   class="btn btn-danger ajax-get" onclick="is_show('<?php echo $v['id']; ?>',0)" title="关闭">关闭</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="rechargeModal" class="modal fade">
    <div class="modal-dialog" style="width:400px;">
        <div class="modal-content">
            ...
            <form class="form-horizontal form-post-addmoney" action="<?php echo url('add_call'); ?>" method="post">
...
<script type="text/javascript">
    ...
    function is_show(id,is_show) {
        $.ajax({
            type: "post",
            url: "<?php echo url('notice/is_call'); ?>",
