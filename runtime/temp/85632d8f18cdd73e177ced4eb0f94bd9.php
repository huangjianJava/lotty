<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/home/wwwroot/dwj/public/../app/admin/view/operation/qrcode_edit.html";i:1527136010;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb panel">
                ...
                <li><a href="<?php echo url('Users/index'); ?>">设置中心</a></li>
                <li class="active">二维码编辑</li>
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form">
                        <form class="form-horizontal adminex-form userForm"  method="post" action="<?php echo url('operation/qrcode_edit'); ?>">
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">名称</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="title" value="<?php echo $data['title']; ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">二维码</label>
                                <div class="col-lg-6">
                                    <p class="bor_b left mg_tb10">
                                        <img height="150px"  src="URL_IMG<?php echo $data['qrcode']; ?>"/><br />
                                    ...
                                    <span class="file_p text-center" id="btn_logo">
                                       ...
                                       <input type="hidden" name="qrcode" value="<?php echo $data['qrcode']; ?>"/>
                                        </span>
                                    </p>
                                </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-lg-6">
                                    <input type="radio" name="type"  value="1"  <?php if($data['type']==1): ?> checked <?php endif; ?>>微信
                                    <input type="radio" name="type"  value="2" <?php if($data['type']==2): ?> checked <?php endif; ?>>支付宝
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">	微信昵称/支付宝名</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="k_name" value="<?php echo (isset($data['k_name']) && ($data['k_name'] !== '')?$data['k_name']:'无'); ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label  class="control-label col-lg-2">微信账号/支付宝账号</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" name="k_card_number" value="<?php echo (isset($data['k_card_number']) && ($data['k_card_number'] !== '')?$data['k_card_number']:'无'); ?>" type="text" />
                                </div>
                            </div>
                            <div class="form-group">
