<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/home/wwwroot/dwj/public/../app/admin/view/money/recharge.html";i:1530455536;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <section class="panel">
                    ...
                    <form class="form-inline" action="<?php echo url(''); ?>">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status">
                                ...
                                <option value='2' <?php if((isset($_GET['status']) && $_GET['status'] == 2)): ?>selected<?php endif; ?>>充值成功</option>
                                <option value='3' <?php if((isset($_GET['status']) && $_GET['status'] == 3)): ?>selected<?php endif; ?> >充值失败</option>
                            </select>
                ...
                <div class="panel-body">
                    <form class="ids" action="<?php echo url('delRecharge'); ?>" method="post">
                        <table class="table">
                            <thead>
                            <tr>
                                <th>用户ID</th>
                            ...
                            <tr>
                                ...
                                <td><?php if($v['type']==1): ?>线上充值<?php elseif($v['type']==2): ?>线下充值<?php elseif($v['type']==3): ?>后台充值<?php endif; ?></td>
                                <td><?php echo (isset($v['name']) && ($v['name'] !== '')?$v['name']:"无"); ?></td>
                                ...
                                <?php endif; ?>
                                <td>
                                    <!--<a href="<?php echo url('edit',['id'=>$v['id']]); ?>" class="fa fa-edit" title="编辑"></a>-->
                                    <?php if(($v['status'] == 1)): ?>
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="dataTables_info" id="dynamic-table_info">
                                充值次数：<?php echo $renshu; ?>&nbsp;&nbsp; 充值总额：<?php echo $total_money; ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="rechargeModal" class="modal fade">
    <div class="modal-dialog" style="width:400px;">
        <div class="modal-content">
            ...
            <form class="form-horizontal form-post-addmoney" action="<?php echo url('addmoney'); ?>" method="post">
