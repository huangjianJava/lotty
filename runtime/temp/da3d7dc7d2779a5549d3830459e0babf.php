<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"/home/wwwroot/dwj/public/../app/home/view/recharge/ali_pay.html";i:1534861918;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
...
<div class="home home-a">
	<div class="er">
		<img src="<?php echo $ali_data['qrcode']; ?>" alt="" />
	</div>
	<div class="pay-text">
		<p class="zfb">
			<img src="__IMG__/zfbpay.png" alt="" />
			支付宝支付
		</p>
		<p>
			<span>充值用户：<?php echo $ali_data['k_name']; ?></span>
		</p>
		<p class="zfb">
			<a>
				请使用支付宝扫描二维码完成支付
