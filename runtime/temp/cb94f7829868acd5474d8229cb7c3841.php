<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"/home/wwwroot/dwj/public/../app/admin/view/rule/admin_user_list.html";i:1512118228;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <ul id="myTab" class="nav nav-tabs">
        <li class="active"><a href="<?php echo url('rule/admin_user_list'); ?>">管理员列表</a></li>
        <li><a href=" <?php echo url('rule/add_admin'); ?>">添加管理员</a></li>
    </ul>
        ...
        <div class="tab-pane fade in active" id="home">
            <table class="table table-striped table-bordered table-hover table-condensed">
                ...
                <tr>
                    ...
                    <td><a href="<?php echo url('rule/edit_admin',array('id'=>$v['id'])); ?>">修改权限或密码</a>|
                        <a href="<?php echo url('rule/del_admin',array('id'=>$v['id'])); ?>" onclick="return confirm('确认删除管理员？')">删除管理员</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </table>
