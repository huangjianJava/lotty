<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/home/wwwroot/dwj/public/../app/admin/view/money/win_lose_member.html";i:1529840703;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading col-xs-12 ">
                    <form class="form-inline" action="<?php echo url('',array('uid'=>$uid)); ?>">
                ...
                <div class="panel-body">
                    <form class="ids" action="<?php echo url(''); ?>" method="post">
                        <table class="table" style="text-align: center">
                            <tbody>
                            <tr style="background:#65CEA7;">
                                <td >总盈亏</td>
                                <td ><?php echo $profit; ?></td>
                            </tr>
                            <tr style="background: #65CEA7">
                                <td>总投注</td>
                                <td><?php echo (isset($betting_total) && ($betting_total !== '')?$betting_total:'0.00'); ?></td>
                                <td>总中奖</td>
                                <td><?php echo (isset($winning_total) && ($winning_total !== '')?$winning_total:'0.00'); ?></td>
                            </tr>
                            <tr style="background: #65CEA7">
                                <td>总充值</td>
                                <td><?php echo (isset($recharge_total) && ($recharge_total !== '')?$recharge_total:'0.00'); ?></td>
                                <td>总提现</td>
                                <td><?php echo (isset($withdrawals_total) && ($withdrawals_total !== '')?$withdrawals_total:'0.00'); ?></td>
                                <td>总回水</td>
                                <td><?php echo (isset($back_total) && ($back_total !== '')?$back_total:'0.00'); ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </form>
