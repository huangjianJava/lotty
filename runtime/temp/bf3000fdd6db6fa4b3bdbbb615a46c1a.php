<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"/home/wwwroot/dwj/public/../app/admin/view/money/cash.html";i:1530455551;s:59:"/home/wwwroot/dwj/public/../app/admin/view/common/base.html";i:1535125972;s:58:"/home/wwwroot/dwj/public/../app/admin/view/common/nav.html";i:1524635392;}*/ ?>
<!DOCTYPE html>
<html lang="zh_ch">
<head>
    <meta charset="utf-8">
                ...
                <header class="panel-heading col-xs-12">
                    ...
                    <form class="form-inline" action="<?php echo url(''); ?>">
                        <div class="form-group">
                            ...
                            <a href="#"  class="btn btn-success ajax-get" onclick="recharge();" title="后台下分">后台下分</a>
                        </div>
                    </form>
                </header>
                    ...
                    <form class="ids" action="<?php echo url('delCash'); ?>" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php if($v['way']==1): ?>微信<?php else: ?>支付宝<?php endif; ?></td>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="rechargeModal" class="modal fade">
    <div class="modal-dialog" style="width:400px;">
        <div class="modal-content">
            ...
            <form class="form-horizontal form-post-addmoney" action="<?php echo url('withdraw_money'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label  class="col-lg-3 col-sm-3 control-label">下分金额</label>
                        <div class="col-lg-8">
